...
- **[implement](./skills/engineering/implement/SKILL.md)** — Schedule tickets by dependency, build with TDD, commit and review each ticket, then run the full suite before moving on.
